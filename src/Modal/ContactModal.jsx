      ...
      <div className="fixed inset-0 flex justify-center items-center z-50 bg-black bg-opacity-70">
        ...
        >
          ...
          <div className="flex flex-col gap-2 text-center w-full">
            <p className="text-white mb-4 md:mb-6 text-[14px] md:text-[20px] font-[300]">
              Leave your details, and we'll get in touch to answer your
              questions and tell you more about the Extendy.
            </p>
            ...
            >
                ...
                type="text"
                placeholder="Name"
                className="w-full px-4 py-2 bg-transparent border-b border-[#FFFFFFB2] text-[12px] md:text-[16px] text-white focus:outline-none"
                value={name}
              ...
              <button
                type="submit"
                className="w-full flex justify-center items-center border-b border-[#FFFFFFB2] py-2 bg-[#FFFFFF33] bg-opacity-30 text-[14px] md:text-[18px] text-[#000000B2] font-[700] rounded-[16px] hover:bg-opacity-50 transition-all h-[100%] min-h-10 mt-4 mb-2"
                disabled={loading}
              >
                {loading ? (
